...
export class SortingDataComponent {
  ...
  tiutionFee = ['All', '30,000 USD/Year or Less', '50,000 USD/Year or Less', '70,000 USD/Year or Less', '90,000 USD/Year or Less']
  ...
  ngOnInit(): void {
    this.store.select('IscData').subscribe(s => this.filterData = s.filters)
  }
